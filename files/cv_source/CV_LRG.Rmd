...
qualifications: PhD, MRes, MSc, BSc
position: Research Fellow, Centre for Climate Communication and Data Science (C3DS)
address: University of Exeter, UK
email: l.roldan-gomez2@exeter.ac.uk
...
tribble(
  ...
  "PhD Advanced Quantitative Methods ", "2025", "University of Exeter", "United Kingdom",
...
tribble(
  ~ Title,
"- Social-Ecological Networks and Risk: How Is Perceived Social and Ecological Risk Associated with Network Structure? (First author with Angela Guerrero, Michele Barnes, Lorien Jasny, Steven Alexander)",
...
tribble(
  ...
  "Introduction to Research Design in Politics and International Relations", "Teaching Assistant, University of Exeter", "United Kingdom", "Jan-Mar 2025",
  "Data Analysis in Social Science II", "", "", "Sep-Dec 2024",
...
library(tibble)
tribble(
  ~ Role, ~ When, ~ Institution, ~ Description,
  "Research Fellow", "2026 - Ongoing", "Centre for Climate Communication and Data Science (C3DS), University of Exeter, UK", "Building AI tools for debunking climate misinformation.",
  "Researcher", "2024 - Ongoing", "Queensland University of Technology, Australia", NA,
  "Contractor", "2017-2018", "Unit for Rural and Agricultural Planning, Colombia", NA,
  "Research Assistant", "Mar-Nov 2014", "Geography Department University of Exeter, United Kingdom", NA,
  "Researcher", "2011-2014", "Institute for Research on Biological Resources Alexander von Humboldt, Colombia", NA,
  "Contractor", "2007-2010", "National Natural Parks System, Colombia", NA,
) %>%
  detailed_entries(Role, When, Institution, why = Description)
```
